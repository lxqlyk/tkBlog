...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="/blog_1/Public/css1/normalize.css">
        <link rel="stylesheet" href="/blog_1/Public/css1/font-awesome.css">
        <link rel="stylesheet" href="/blog_1/Public/css1/bootstrap.min.css">
        <link rel="stylesheet" href="/blog_1/Public/css1/templatemo-style.css">
        <script src="/blog_1/Public/js1/vendor/modernizr-2.6.2.min.js"></script>
         <script type="text/javascript" charset="utf-8" src="/blog_1/Public/ueditor/ueditor.config.js"></script>
        <script type="text/javascript" charset="utf-8" src="/blog_1/Public/ueditor/ueditor.all.min.js"> </script>
        <script type="text/javascript" charset="utf-8" src="/blog_1/Public/ueditor/lang/zh-cn/"></script>
        <style>
    ...
    <body>
        ...
        <div class="site-bg" style="background-image:url('/blog_1/Public/images1/bg.jpg') "></div>
                ...
                <div class="col-md-9 col-sm-12 content-holder">
                    ...
                    <div id="menu-container">
                        <div class="logo-holder logo-top-margin">
                            <a href="#" class="site-brand"><img src="/blog_1/Public/images1/logo.png" alt=""></a>
                        </div>
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <div class="box-content profile">
                                        ...
                                        <div class="profile-thumb">
                                            <!--<img src="/blog_1/Public/images1/8.jpg" alt="">-->
                                            <img src="<?php echo ($head); ?>" alt="">
                                        </div>
                                        <div class="profile-content">
                                            <h5 class="profile-name"><?php echo ($name); ?></h5>
                                            <span class="profile-role"></span>                                   
                                            <ul>
                                                <li><lable>性　别：</lable><?php echo ($agender); ?></li>
                                                <li><lable>生　日：</lable><?php echo ($birth); ?></li>
                                                <li><lable>星　座：</lable><?php echo ($star); ?></li>
                                                <li><lable>所在地：</lable><?php echo ($add); ?></li>
                                                <li><lable>座右铭：</lable><?php echo ($motto); ?></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <div class="box-content">
                                        ...
                                        <div class="project-item">
                                            <img src="/blog_1/Public/images1/7.jpg" alt="">
...
<!--                                <div class="col-md-4 col-sm-4">
        ...
        <script src="/blog_1/Public/js1/vendor/jquery-1.10.2.min.js"></script>
        <script src="/blog_1/Public/js1/plugins.js"></script>
        <script src="/blog_1/Public/js1/main.js"></script>
