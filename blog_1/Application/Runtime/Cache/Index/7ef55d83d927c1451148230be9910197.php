        ...
        <header class="header">
            <div class="header-inner pie">
                <div class="header-top pie">
                    <div class="container">
                        <h1 class="logo pie" style="background-image: url('/blog_1/Public/img/blogbus_logo.png')"><lable>logo</lable></h1>
                        <nav class="top-nav">
                            <ul>
<!--                                <li class="ico ios"><a href=''><span class="pie"></span></a></li>
                                ...
                                <li class="nologin"><a href="<?php echo U('admin/login/index');?>" rel="external nofollow" ><?php echo ($login); ?></a></li>
        ...
        <div id="wrapper">
            ...
            <div class="content">
                <div class="container stream">
                    <form action="<?php echo U('bloglist/index');?>" method="get">
                     <?php foreach($bloglist as $key => $val): ?> 
                  
                    <div class="item pie">
                        <div class="article">
                            <p   target='_blank' title='拥有回忆的人是幸福的'>
                                <img  src="<?php echo ($val['image']); ?>" width="190" height="146"></p>
                            <h4><a title='拥有回忆的人是幸福的' target='_blank' title='拥有回忆的人是幸福的' href="<?php echo U('Bloglist/index').'?id=' .$val['id'];?>"><?php echo ($val['title']); ?></a></h4>
                        </div>
                        <div class="credits">
                            <a  target='_blank' class="avatar" rel="external nofollow" href=""><img alt="" src="<?php echo ($val['authorhead']); ?>" width="30" height="30"></a>
                            <p  target='_blank' class="author" rel="external nofollow"  href=""><?php echo ($val['author']); ?></p>
                            发布在 <p  target='_blank' class="title"  href=""><?php echo ($val[artid]); ?>	  </p>
