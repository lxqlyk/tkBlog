...
<html lang="en">
  ...
  <!-- ========== Css Files ========== -->
  <link href="__PUBLIC__/css/root.css" rel="stylesheet">
  <style type="text/css">
  ...
  <body>
    ...
    <div class="login-form">
        ...
        <div class="top">
          <img src="__PUBLIC__/img/blogbus_logo.png" alt="icon" class="icon">
...
<!--            <label for="checkbox101"> 记住我</label>-->
      ...
      <div class="footer-links row">
        <div class="col-xs-6"><a href="{:U('admin/register/register')}"><i class="fa fa-external-link"></i> 注册</a></div>
